...
-- (engine::staging::claim::claim) is what makes two overlapping claims land
...
-- batch's free buckets by (engine::staging::claim::count_live_drainers).
...
-- configuration and batch size alone (engine::staging::claim::SEG_BUCKETS/
